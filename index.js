$("#btnCalculate").click(function(){
    ...
    var planetText = $('#planet option:selected').text();
    var planetGrav = $('#planet option:selected').val();
    var weightOnPlanet = userWeight * planetGrav;
    $('#output').text("If you were on " + planetText + " you would weigh " +weightOnPlanet + " lbs!");
});
...
//     output.innerHTML += '<br><img src="' + planets[planetMultiplier.selectedIndex].imagePath + '">';
